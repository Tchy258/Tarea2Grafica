...
def setProjection(controller,lightPipeline, texPipeline, width, height,spotlightsPool,theta,hora):
    ...
    glUniform3f(glGetUniformLocation(lightPipeline.shaderProgram, "pointLights[0].diffuse"), 0.4, 0.4, 0.4)
    glUniform3f(glGetUniformLocation(lightPipeline.shaderProgram, "pointLights[0].specular"), 0.4, 0.4, 0.4)
    ...
    glUniform3f(glGetUniformLocation(lightPipeline.shaderProgram, "pointLights[1].diffuse"), 0.2, 0.2, 0.2)
    glUniform3f(glGetUniformLocation(lightPipeline.shaderProgram, "pointLights[1].specular"), 0.2, 0.2, 0.2)
